...
1. Go to this link: https://classroom.github.com/a/svEUt7QF and accept the assignment. It should take you to your project page. (If it doesn't, click on the link above again, and click on the link to the project page).
